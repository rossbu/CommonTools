...
public class TestPassByReference {
    ...
    public static void main(String[] args) {
        // int, Integer, String are immutable type.  you can't pass by reference of value but pass by
        // value only ,but apache commons has mutableInt and etc.
        int i = 25;
        Integer boxedI = Integer.valueOf(25);
    ...
    public static void integerBoxedMethod(Integer iTest) {
        iTest = Integer.valueOf(100); // change it
        System.out.println(iTest); // print it (4)
        return;
    }
    ...
    public static void sbMethod(StringBuffer sbTest) { // StringBuffer is just like other customized Class , that you can change the
        // 'content' of it .
