...
/**
 * Created by tbu Update 2019 with more explanation.
    <pre>
        ...
        testing code is in below example.
         ...
         List < ? extends T> 是个大容器，里面的T就是家长，一旦这个‘家容器’被实例话建立一个家了，这个时候T就是这个家的大家长，别人都不可以进来了，你可以GET,就是可以查看一下这个家里有谁
         List < ? super T>   是个大容器，里面的T就是家里得最小辈，剩下都比他大，爸爸，爷爷奶奶，太爷爷等。这些老家伙只入不出，你可以给我东西(add)，但是你不能要我东西看(get) ,所以这些大爷们都是顾客consumer只入不出
