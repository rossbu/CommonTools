package com.demo.datasecurity.encryption.jwt;
...
public class JwtRSADemo {
    ...
    public static void main(String[] args) throws Exception {
        JwtRSADemo encryptedJWTTest = new JwtRSADemo();
        encryptedJWTTest.testEncryptAndDecrypt();
    }
    public void testEncryptAndDecrypt()
        ...
        JWEHeader header = new JWEHeader(RSA_OAEP, A128GCM);
        ...
        // Parse back
        EncryptedJWT jwtback = EncryptedJWT.parse(jwtString);
        ...
        // Decrypt
        jwtback.decrypt(decrypter);
        System.out.println("jwtback: " + jwtback.getParsedString());
...
//        assertEquals(jti, jwt.getJWTClaimsSet().getJWTID());
    ...
    public void testTrimWhitespace()
        ...
        EncryptedJWT jwt = new EncryptedJWT(new JWEHeader(DIR, A128GCM), new JWTClaimsSet.Builder().build());
