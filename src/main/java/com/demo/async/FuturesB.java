...
public class FuturesB {
  ...
  /**
   * Demonstrate how futures can easily become blocking and prevent other work from being performed
   * asynchronously.
   */
  ...
  /**
   * Demonstrates how reordering of Future.get() can improve the situation but that it still doesn't
   * address differing response latencies of f1 and f2.
   */
  ...
  /**
   * Demonstrate how changing where threads are injected can solve the issue of run2() at the cost
   * of incidental complexity being added to the code.
   *
   * <p>This same example could be accomplished by refactoring CallToRemoteServiceC to accept a
   * Future<String> instead of String but the principle is the same.
   */
   ...
   *
   * <p>This successfully executes multiple calls in parallel but then synchronously handles each
   * response in the order they were put in the list rather than the order they complete.
   */
   ...
   *
   * <p>This becomes unwieldy and error prone quickly.
   */
